...
public class HumanPlayer extends Player {
	 ...
	 * 
	 * @param name
	 *            Name of the created player
	 * @param mark
	 *            Mark of the created player
	 */
	...
	/*
	 * while (!valid) { System.out.println("ERROR:  " + choice +
	 * " is no valid choice."); choice = readInt(prompt); valid =
	 * board.isField(choice) && board.isEmptyField(choice); } return choice;
	 */
